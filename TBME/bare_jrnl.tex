...
In this study, we use the MIT/BIH arrhythmia database as a standard test data set, and in the model training step, we use the collected data from a real-world collected data.
The MIT/BIH data set had been quite popular in the research of ECG signal processing and machine learning literatures.
...
These continues ECG signals are band-pass filtered at 0.1-100 Hz.
...
As the deep learing methods are capable of learning features from unlabel data, wo collect hundreds pieces of Holter records from a cardiovascular specialist hospital.
Setting of the recordings were based on Lead I same as in the MIT/BHI database, signals filter were set as 0.1-75 Hz.
For the specific classification task, the signal frequence higher than 75 Hz has little effect on the classification of an ECG sample, since the 
%A description of the data set could be checked in Table 1.
