...
\title{Electrocardiography Classification and Arrhythmia Detection Based on Deep Learning Methods}
%
%
...
% The paper headers
\markboth{IEEE Transactions on Information Technology in Biomedicine,~Vol.~, No.~, December~2014}%
{Shell \MakeLowercase{\textit{et al.}}: Electrocardiography Heartbeat Classification with Deep Learning Methods}
